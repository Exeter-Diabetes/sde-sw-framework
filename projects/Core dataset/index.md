...
| 12 | Follow the DDSC algorithm to define diabetes type



using insulin use (step 4) and type 1 and type 2 code counts (step 8) as per our algorithm | Table with 1 row per patient and assigned diabetes type: 'type 1', 'type 2' or 'unclassified' | Of those with a diabetes code: % type 1, % type 2, % unclassified |
