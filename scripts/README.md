...
1. Scripts that implement algorithmic rules for generation of code lists from various data sources
2. Tools for building and deploying the data specification website
